...
public class FlutterRTCVideoRenderer implements EventChannel.StreamHandler {
   ...
   /**
    ...
    /**
     * Sets a video track resolved directly from its owning PeerConnection.
     *
     * Unified Plan can replace or populate its MediaStream wrapper after the
     * Flutter onTrack event. Keeping the native receiver track avoids leaving
     * the texture permanently attached to an empty wrapper.
     */
    public void setTrack(VideoTrack videoTrack, String mediaStreamId, String ownerTag) {
